...
const Auth = ()=>{
    ...
    return(
        ...
        //     </div>
        // </div>
        <div className="bg-[#515151] h-screen w-screen flex flex-col justify-center items-center">
            <Image src={logo} alt="logo" height="80" width="50" className="h-24 w-auto"/>
            <h1 className="jockey-one-regular text-3xl font-400 text-[#F1DA00]">Book face</h1>
            <div className="w-[70vw] md:w-[30vw] flex flex-col justify-center items-center">
                ...
                <Input 
                    ...
                    value={password}
                />
                <button onClick={variant==='login'?login:register} className="bg-blue-600 py-3 text-white font-medium rounded-md w-[100%] mt-10
                        hover:bg-blue-800 transition">
                            {variant==='login'?'Login':'Sign Up'}
                </button>
